...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/install' '--with-openssl=/tools/deps' "
                "'--without-ensurepip' '--enable-shared' "
                "'--enable-optimizations' 'CC=clang' 'CFLAGS= -fPIC "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.8.6/coverage.info',
 'COVERAGE_REPORT': '/build/Python-3.8.6/lcov-report',
 ...
 'LIBPL': '/install/lib/python3.8/config-3.8-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-lnsl               -L/install/lib -lz         -lbz2  '
                 '-lcrypt  -L/tools/deps/lib -lncursesw  -L/tools/deps/lib '
                 '-lpanelw -lncursesw  -lffi -ldl   -L/tools/deps/lib -ldb   '
                 '-L/tools/deps/lib -lssl -lcrypto    -L/tools/deps/lib '
                 '-llzma    -lrt   -L/tools/deps/lib -lsqlite3  -lssl '
                 '-lcrypto  -L/tools/deps/lib -ltcl8.6 -ltk8.6 -lX11 -lxcb '
                 '-lXau  -luuid    -L/tools/deps/lib -lreadline -lncursesw',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 ...
 'MODBUILT_NAMES': 'array  cmath  math  _contextvars  _struct  _weakref  '
                   ...
                   '_heapq  _asyncio  _statistics  unicodedata  fcntl  spwd  '
                   'grp  select  mmap  _csv  _socket  nis  termios  resource  '
                   ...
                   '_opcode  _posixshmem  _queue  _sqlite3  _ssl  _tkinter  '
                   '_uuid  ossaudiodev  pyexpat  readline  posix  errno  pwd  '
                   ...
                   '_symtable  xxsubtype',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-lnsl               -L/install/lib -lz         -lbz2  -lcrypt  '
            '-L/tools/deps/lib -lncursesw  -L/tools/deps/lib -lpanelw '
            '-lncursesw  -lffi -ldl   -L/tools/deps/lib -ldb   '
            '-L/tools/deps/lib -lssl -lcrypto    -L/tools/deps/lib -llzma    '
            '-lrt   -L/tools/deps/lib -lsqlite3  -lssl -lcrypto  '
            '-L/tools/deps/lib -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau  -luuid    '
            '-L/tools/deps/lib -lreadline -lncursesw',
 'MODOBJS': 'Modules/_abc.o Modules/_asynciomodule.o Modules/_bisectmodule.o '
            ...
            'Modules/_struct.o Modules/_testinternalcapi.o '
            'Modules/_threadmodule.o Modules/_tkinter.o Modules/_tracemalloc.o '
            'Modules/_uuidmodule.o Modules/_weakref.o Modules/arraymodule.o '
            ...
            'Modules/fourstep.o Modules/grpmodule.o Modules/hashtable.o '
            ...
            'Modules/multiprocessing.o Modules/nismodule.o '
            'Modules/numbertheory.o Modules/ossaudiodev.o '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.8.6',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.8.6 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.8.6 ./python '
 ...
 'abs_builddir': '/build/Python-3.8.6',
 'abs_srcdir': '/build/Python-3.8.6',
